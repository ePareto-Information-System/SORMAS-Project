...
public abstract class AbstractBeanTest {
	...
	public HospitalizationFacade getHospitalizationFacade() {
		return getBean(HospitalizationFacadeEjb.HospitalizationFacadeEjbLocal.class);
	}
	...
	public FoodHistoryFacade getFoodHistoryFacade() {
		return getBean(FoodHistoryFacadeEjb.FoodHistoryEjbLocal.class);
	}
