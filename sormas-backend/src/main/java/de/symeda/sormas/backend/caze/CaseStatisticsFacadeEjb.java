...
public class CaseStatisticsFacadeEjb implements CaseStatisticsFacade {
	...
	public Pair<String, List<Object>> buildCaseCountQuery(
		...
		StatisticsCaseAttributeEnum groupingB,
		...
		if (subGroupingA == StatisticsCaseSubAttributeEnum.FACILITY || subGroupingB == StatisticsCaseSubAttributeEnum.FACILITY) {
		...
		if (subGroupingA == StatisticsCaseSubAttributeEnum.COMMUNITY || subGroupingB == StatisticsCaseSubAttributeEnum.COMMUNITY) {
			caseJoinBuilder.append(" LEFT JOIN ")
		...
		if (subGroupingA == StatisticsCaseSubAttributeEnum.DISTRICT || subGroupingB == StatisticsCaseSubAttributeEnum.DISTRICT) {
			caseJoinBuilder.append(" LEFT JOIN ")
		...
		if (subGroupingA == StatisticsCaseSubAttributeEnum.REGION || subGroupingB == StatisticsCaseSubAttributeEnum.REGION) {
			caseJoinBuilder.append(" LEFT JOIN ")
		...
		if (groupingA == StatisticsCaseAttributeEnum.ONSET_TIME || groupingB == StatisticsCaseAttributeEnum.ONSET_TIME || caseCriteria.hasOnsetDate()) {
			caseJoinBuilder.append(" LEFT JOIN ")
		...
		if (groupingA == StatisticsCaseAttributeEnum.SEX
			|| groupingB == StatisticsCaseAttributeEnum.SEX
			|| groupingA == StatisticsCaseAttributeEnum.AGE_INTERVAL_1_YEAR
			|| groupingB == StatisticsCaseAttributeEnum.AGE_INTERVAL_1_YEAR
			|| groupingA == StatisticsCaseAttributeEnum.AGE_INTERVAL_5_YEARS
			|| groupingB == StatisticsCaseAttributeEnum.AGE_INTERVAL_5_YEARS
			|| groupingA == StatisticsCaseAttributeEnum.AGE_INTERVAL_CHILDREN_COARSE
			|| groupingB == StatisticsCaseAttributeEnum.AGE_INTERVAL_CHILDREN_COARSE
			|| groupingA == StatisticsCaseAttributeEnum.AGE_INTERVAL_CHILDREN_FINE
			|| groupingB == StatisticsCaseAttributeEnum.AGE_INTERVAL_CHILDREN_FINE
			|| groupingA == StatisticsCaseAttributeEnum.AGE_INTERVAL_CHILDREN_MEDIUM
			|| groupingB == StatisticsCaseAttributeEnum.AGE_INTERVAL_CHILDREN_MEDIUM
			|| groupingA == StatisticsCaseAttributeEnum.AGE_INTERVAL_BASIC
			|| groupingB == StatisticsCaseAttributeEnum.AGE_INTERVAL_BASIC
		...
		if (CollectionUtils.isNotEmpty(caseCriteria.getReportingUserRoles())
			|| groupingA == StatisticsCaseAttributeEnum.REPORTING_USER_ROLE
			|| groupingB == StatisticsCaseAttributeEnum.REPORTING_USER_ROLE) {
			caseJoinBuilder.append(" LEFT JOIN ")
		...
		if (CollectionUtils.isNotEmpty(caseCriteria.getPersonDistricts())) {
			List<District> districtIds = districtService.getByReferenceDtos(caseCriteria.getPersonDistricts());
			extendFilterBuilderWithSimpleValue(
				caseFilterBuilder,
				filterBuilderParameters,
				Location.TABLE_NAME,
		...
		if (CollectionUtils.isNotEmpty(caseCriteria.getPersonCommunities())) {
			List<Community> communityIds = communityService.getByReferenceDtos(caseCriteria.getPersonCommunities());
			extendFilterBuilderWithSimpleValue(
				caseFilterBuilder,
				filterBuilderParameters,
				Location.TABLE_NAME,
		...
		if (CollectionUtils.isNotEmpty(caseCriteria.getDistricts())) {
			List<District> districtIds = districtService.getByReferenceDtos(caseCriteria.getDistricts());
			extendFilterBuilderWithSimpleValue(
				caseFilterBuilder,
				filterBuilderParameters,
				Case.TABLE_NAME,
	...
	public Pair<String, List<Object>> buildPopulationQuery(
		...
		if (CollectionUtils.isNotEmpty(caseCriteria.getCommunities())) {
			...
			communityIds = null;
			usesCommunitys = subGroupingA == StatisticsCaseSubAttributeEnum.COMMUNITY || subGroupingB == StatisticsCaseSubAttributeEnum.COMMUNITY;
		...
		if (CollectionUtils.isNotEmpty(caseCriteria.getDistricts())) {
			...
			usesDistricts = subGroupingA == StatisticsCaseSubAttributeEnum.DISTRICT || subGroupingB == StatisticsCaseSubAttributeEnum.DISTRICT;
		...
		if (CollectionUtils.isNotEmpty(caseCriteria.getSexes())) {
			...
			boolean usesSex = groupingA == StatisticsCaseAttributeEnum.SEX || groupingB == StatisticsCaseAttributeEnum.SEX;
		...
		if (CollectionUtils.isNotEmpty(caseCriteria.getAgeIntervals())) {
			...
			boolean usesAgeGroup =
				groupingA == StatisticsCaseAttributeEnum.AGE_INTERVAL_5_YEARS || groupingB == StatisticsCaseAttributeEnum.AGE_INTERVAL_5_YEARS;
		...
		if (communityIds != null || subGroupingA == StatisticsCaseSubAttributeEnum.COMMUNITY || subGroupingB == StatisticsCaseSubAttributeEnum.COMMUNITY) {
			...
			|| subGroupingA == StatisticsCaseSubAttributeEnum.DISTRICT
			|| subGroupingB == StatisticsCaseSubAttributeEnum.DISTRICT) {
	...
	private String buildPopulationGroupingSelect(StatisticsCaseAttributeEnum grouping, StatisticsCaseSubAttributeEnum subGrouping) {
	...
	private String buildCaseGroupingSelectQuery(StatisticsCaseAttributeEnum grouping, StatisticsCaseSubAttributeEnum subGrouping, String groupAlias) {
	...
	private void extendGroupingBuilderWithAgeInterval(StringBuilder groupingBuilder, StatisticsCaseAttributeEnum grouping, String groupAlias) {
		...
		if (grouping != StatisticsCaseAttributeEnum.AGE_INTERVAL_BASIC && grouping != StatisticsCaseAttributeEnum.AGE_INTERVAL_5_YEARS) {
...
//	@Override
//	public List<StatisticsCaseCountDto> queryCaseCount(StatisticsCaseCriteria criteria,
//			StatisticsCaseAttributeEnum enum1, StatisticsCaseAttributeEnum enum2, StatisticsCaseAttributeEnum enum3,
//			StatisticsCaseAttributeEnum enum4, boolean includePopulation, Boolean value,
//			Integer populationReferenceYear) {
...
//	@Override
//	@SuppressWarnings("unchecked")
//		public List<StatisticsCaseCountDto> queryCaseCount__(
//				StatisticsCaseCriteria caseCriteria, 
...
//			StatisticsCaseAttribute rowGrouping,
//			StatisticsCaseAttribute rowSubGrouping,
//			StatisticsCaseAttribute columnGrouping, 
//			StatisticsCaseAttribute columnSubGrouping,
...
//	private Pair<String, List<Object>> buildCaseCountQuery(StatisticsCaseCriteria caseCriteria,
//			StatisticsCaseAttribute rowGrouping, StatisticsCaseAttribute rowSubGrouping,
//			StatisticsCaseAttribute columnGrouping, StatisticsCaseAttribute columnSubGrouping) {
//		StringBuilder caseJoinBuilder = new StringBuilder();
//
