...
package de.symeda.sormas.backend.sample.sampleimport;
...
@RightsAllowed(UserRight._SAMPLE_IMPORT)
public class SampleImportFacadeEjb implements CaseImportFacade {

	private final Logger LOGGER = LoggerFactory.getLogger(SampleImportFacadeEjb.class);
...
//			PersonDto savedPerson = personFacade.savePerson(person);
	...
	@LocalBean
	@Stateless
	public static class CaseImportFacadeEjbLocal extends SampleImportFacadeEjb {
