...
public abstract class AbstractCoreAdoServiceOld<ADO extends CoreAdo> extends AbstractDeletableAdoService<ADO> {
	...
	protected AbstractCoreAdoServiceOld(Class<ADO> elementClass) {
		super(elementClass);
	}
