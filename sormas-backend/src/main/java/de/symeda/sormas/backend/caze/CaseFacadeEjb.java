...
//    private ManagedScheduledExecutorService executorService;
    ...
    @Override
    public List<CaseMergeIndexDto[]> getCasesForDuplicateMerging(CaseCriteria criteria, Integer limit, boolean showDuplicatesWithDifferentRegion) {
...
//    }
        ...
        if (existingCase != null && newCase.getOutcome() != existingCase.getOutcome()) {
            ...
            if (newCase.getOutcome() == CaseOutcome.DECEASED) {
                if (newCase.getPerson().getPresentCondition() != PresentCondition.DEAD
                    ...
                    PersonDto existingPerson = personFacade.toDto(newCase.getPerson());
    ...
    public static CaseReferenceDto toReferenceDto(Case entity) {
        CaseReferenceDto result = null;

        if (entity != null) {
            result = entity.toReference();
        }
    ...
    @Override
    protected void pseudonymizeDto(Case source, CaseDataDto dto, Pseudonymizer pseudonymizer, boolean inJurisdiction) {
    ...
    public Case fillOrBuildEntity(@NotNull CaseDataDto source, Case target, boolean checkChangeDate) {
        ...
        target.setClinicalCourse(clinicalCourseFacade.fillOrBuildEntity(source.getClinicalCourse(),target.getClinicalCourse(),
                checkChangeDate));
        if (source.getMaternalHistory() == null) {
        ...
        if (source.getSormasToSormasOriginInfo() != null) {
            target.setSormasToSormasOriginInfo(originInfoFacade.fillOrBuildEntity(source.getSormasToSormasOriginInfo(),target.getSormasToSormasOriginInfo(), checkChangeDate));
        }
...
//                cb.not(service.createChangeDateFilter(cb, from, notChangedTimestamp, true)));
    ...
    @Override
    public Integer saveBulkCase(List<String> caseUuidList, CaseBulkEditData updatedCaseBulkEditData, boolean diseaseChange, boolean diseaseVariantChange, boolean classificationChange, boolean investigationStatusChange, boolean outcomeChange, boolean surveillanceOfficerChange) {
        return null;
    }

    @Override
    public Integer saveBulkEditWithFacilities(List<String> caseUuidList, CaseBulkEditData updatedCaseBulkEditData, boolean diseaseChange, boolean diseaseVariantChange, boolean classificationChange, boolean investigationStatusChange, boolean outcomeChange, boolean surveillanceOfficerChange, Boolean doTransfer) {
        return null;
    }
    ...
    @Override
    public List<CaseDataDto> getRelevantCasesForVaccination(VaccinationDto vaccination) {
        return null;
    }
    ...
    public void updateSymptomsByVisit(Visit visit) {
        CaseDataDto cazeDto = toCaseDto(visit.getCaze());
