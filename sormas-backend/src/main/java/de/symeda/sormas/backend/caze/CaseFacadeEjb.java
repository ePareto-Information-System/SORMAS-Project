...
//			caseService.inJurisdictionOrOwned(caseQueryContext)
	...
	public void validate(@Valid CaseDataDto caze) throws ValidationRuntimeException {
		...
		if ((caze.getCaseOrigin() == null || caze.getCaseOrigin() == CaseOrigin.IN_COUNTRY) && (caze.getHealthFacility() == null && caze.getFacilityType() == null && caze.getHealthFacilityDetails() == null)) {
