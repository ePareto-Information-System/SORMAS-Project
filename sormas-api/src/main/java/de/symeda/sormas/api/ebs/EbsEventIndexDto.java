...
public class EbsEventIndexDto extends PseudonymizableIndexDto {
	...
	public EbsEventIndexDto(String uuid) {
		super(uuid);
	}
	...
	public boolean equals(Object o) {
		...
		EbsEventIndexDto that = (EbsEventIndexDto) o;
