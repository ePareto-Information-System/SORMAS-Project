...
public class EbsEventDto extends PseudonymizableDto {
	...
	public static EbsEventDto build() {
		EbsEventDto ebs = new EbsEventDto();
	...
	public static EbsEventDto build(CountryReferenceDto country, UserDto user) {
		EbsEventDto ebs = build();
	...
	public EbsEventDto(
			Date reportDateTime, // java.util.Date
			EbsSourceType sourceInformation, // de.symeda.sormas.api.ebs.EbsSourceType
			Double ebsLatitude, // double
			Double ebsLongitude, // double
			Double locationLatitude, // double
			Double locationLongitude, // double
			PersonReporting categoryOfInformant, // de.symeda.sormas.api.ebs.PersonReporting
			String personRegistering, // java.lang.String
			String personDesignation, // java.lang.String
			String personPhone, // java.lang.String
			String informantName, // java.lang.String
			String informantTel, // java.lang.String
			String sourceName, // java.lang.String
			String sourceUrl, // java.lang.String
			Date dateOnset, // java.util.Date
			UserReferenceDto reportingUser, // de.symeda.sormas.backend.user.User
			UserReferenceDto responsibleUser, // de.symeda.sormas.backend.user.User
			String other, // java.lang.String
			DeletionReason deletionReason, // de.symeda.sormas.api.common.DeletionReason
			String otherDeletionReason, // java.lang.String
			String otherInformant // java.lang.String
	) {
		this.reportDateTime = reportDateTime;
		this.sourceInformation = sourceInformation;
		this.ebsLatitude = ebsLatitude;
		this.ebsLongitude = ebsLongitude;
		this.ebsLocation = new LocationDto();
		this.ebsLocation.setLatitude(locationLatitude);
		this.ebsLocation.setLongitude(locationLongitude);
