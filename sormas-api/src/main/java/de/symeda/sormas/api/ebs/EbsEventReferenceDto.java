...
public class EbsEventReferenceDto extends ReferenceDto {

	private static final long serialVersionUID = 2430932452606853497L;

	public EbsEventReferenceDto() {

	}

	public EbsEventReferenceDto(String uuid) {
		setUuid(uuid);
	}

	public EbsEventReferenceDto(String uuid, String caption) {
		setUuid(uuid);
		setCaption(caption);
	}
