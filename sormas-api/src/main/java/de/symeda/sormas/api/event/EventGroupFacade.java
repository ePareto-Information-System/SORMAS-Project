...
public interface EventGroupFacade {
	...
	List<EventGroupIndexDto> getIndexList(EventGroupCriteria eventGroupCriteria, Integer first, Integer max,
	...
	void notifyEventAddedToEventGroup(EventGroupReferenceDto eventGroupReference,
			List<EventReferenceDto> eventReferences);

	void notifyEventRemovedFromEventGroup(EventGroupReferenceDto eventGroupReference,
			List<EventReferenceDto> eventReferences);
}
