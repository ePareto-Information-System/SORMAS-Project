...
public interface ImportFacade {
	...
	/**
	 * Creates a .csv file with one row containing all relevant column names of the
	 * case entity and its sub-entities and returns the path to the .csv file that
	 * can then be used to offer it as a download.
	 */
