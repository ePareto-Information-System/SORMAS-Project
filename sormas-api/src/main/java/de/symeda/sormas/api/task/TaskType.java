...
public enum TaskType {
	...
	ACTIVE_SEARCH_FOR_OTHER_CASES(TaskContext.CASE), CASE_ISOLATION(TaskContext.CASE),
	CASE_INVESTIGATION(TaskContext.CASE), CASE_MANAGEMENT(TaskContext.CASE), CASE_BURIAL(TaskContext.CASE),
	CONTACT_TRACING(TaskContext.CASE), SAMPLE_COLLECTION(TaskContext.CASE), CONTACT_INVESTIGATION(TaskContext.CONTACT),
	CONTACT_FOLLOW_UP(TaskContext.CONTACT), ANIMAL_TESTING(TaskContext.EVENT), EVENT_INVESTIGATION(TaskContext.EVENT),
	EVENT_CONTINUE_INVESTIGATION(TaskContext.EVENT), EVENT_REQUEST_ADDITIONAL_INFORMATION(TaskContext.EVENT),
	...
	QUARANTINE_PLACE(TaskContext.EVENT, TaskContext.CASE), VACCINATION_ACTIVITIES(TaskContext.EVENT, TaskContext.CASE),
	...
	DAILY_REPORT_GENERATION(TaskContext.GENERAL), SURVEILLANCE_REPORT_GENERATION(TaskContext.GENERAL),
