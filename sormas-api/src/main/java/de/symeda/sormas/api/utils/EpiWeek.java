...
public class EpiWeek implements Serializable, Comparable<EpiWeek>, StatisticsGroupingKey {
	...
	public String toString(Language language) {
		...
		return I18nProperties.getString(Strings.weekShort) + " " + week + (year != null
	...
	/**
	 * Returns a human-readable representation of the epi week, starting from the
	 * first day of the week until the specified end date. This should ideally lay
	...
	public String toString(Date endDate, Language language) {
		...
		return I18nProperties.getString(Strings.weekShort) + " " + week
				+ (year != null
						? ("-" + year + " ("
								+ DateHelper.formatDateWithoutYear(DateHelper.getEpiWeekStart(this), language) + " - "
	...
	/**
	 * Returns a human-readable representation of the epi week, starting from the
	 * first day of the week for as many days as specified by epi week length.
	 */
		...
		return I18nProperties.getString(Strings.weekShort) + " " + week + (year != null
				? ("-" + year + " (" + DateHelper.formatDateWithoutYear(DateHelper.getEpiWeekStart(this), language)
						...
						+ DateHelper.formatLocalDate(
								DateHelper.addDays(DateHelper.getEpiWeekStart(this), epiWeekLength), language)
						+ ")")
				: "");
	}
	...
	public int keyCompareTo(StatisticsGroupingKey o) {
		...
		if ((this.getYear() == null && other.getYear() != null)
			...
			throw new UnsupportedOperationException(
					"Can't compare an epi week with a year to an epi week without a year");
		}
