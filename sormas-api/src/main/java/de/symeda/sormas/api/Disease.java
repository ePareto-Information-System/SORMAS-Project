...
public enum Disease implements StatisticsGroupingKey {
	...
	AFP(true, true, true, false, 0, true, false, false), CHOLERA(true, true, true, true, 5, true, false, false),
	CONGENITAL_RUBELLA(true, true, true, true, 21, true, false, false),
	CSM(true, true, true, false, 10, true, false, false), DENGUE(true, true, true, false, 14, true, false, false),
	EVD(true, true, true, true, 21, true, false, false), GUINEA_WORM(true, true, true, false, 0, true, false, false),
	LASSA(true, true, true, true, 21, true, false, false), MEASLES(true, true, true, false, 21, true, true, false),
	MONKEYPOX(true, true, true, true, 21, true, false, false),
	NEW_INFLUENZA(true, true, true, true, 17, true, false, false),
	PLAGUE(true, true, true, true, 7, true, false, false), POLIO(true, true, true, false, 0, true, false, false),
	UNSPECIFIED_VHF(true, true, true, true, 21, true, false, false),
	WEST_NILE_FEVER(true, false, true, false, 0, true, false, false),
	YELLOW_FEVER(true, true, true, false, 6, true, false, false), RABIES(true, true, true, true, 6, true, false, false),
	ANTHRAX(true, true, true, false, 0, true, false, false), CORONAVIRUS(true, true, true, true, 14, true, true, true),
	...
	OTHER(true, true, true, true, 21, false, false, false), UNDEFINED(true, true, true, true, 0, false, false, false);
	...
	Disease(boolean defaultActive, boolean defaultPrimary, boolean defaultCaseBased, boolean defaultFollowUpEnabled,
			int defaultFollowUpDuration, boolean variantAllowed, boolean defaultExtendedClassification,
