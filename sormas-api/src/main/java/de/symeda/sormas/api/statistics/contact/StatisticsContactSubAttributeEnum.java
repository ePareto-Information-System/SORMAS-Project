...
public enum StatisticsContactSubAttributeEnum {
	
//public enum StatisticsContactSubAttribute {
	...
	StatisticsContactSubAttributeEnum(boolean usedForFilters, boolean usedForGrouping) {
