...
public final class ImportExportUtils {
	...
	public static List<ExportPropertyMetaInfo> getCaseExportProperties(PropertyCaptionProvider propertyCaptionProvider,
			final boolean withFollowUp, final boolean withCaseManagement) {
	...
	public static List<ExportPropertyMetaInfo> getEventExportProperties(PropertyCaptionProvider propertyCaptionProvider,
