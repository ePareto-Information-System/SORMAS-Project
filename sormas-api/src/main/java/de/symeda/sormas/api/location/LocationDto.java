...
public class LocationDto extends PseudonymizableDto {
	...
	public String toString() {
		...
		return LocationReferenceDto.buildCaption(region != null ? region.getCaption() : null,
				district != null ? district.getCaption() : null, community != null ? community.getCaption() : null,
				city, street, houseNumber, additionalInformation);
	}

	public LocationReferenceDto toReference() {

		return new LocationReferenceDto(getUuid(), region != null ? region.getCaption() : null,
				district != null ? district.getCaption() : null, community != null ? community.getCaption() : null,
				city, street, houseNumber, additionalInformation);
	}

	public boolean checkIsEmptyLocation() {
		return details == null && city == null && areaType == null && region == null && district == null
				&& community == null && street == null && houseNumber == null && additionalInformation == null;
	}
