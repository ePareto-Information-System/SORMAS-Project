...
//	public static RegionReferenceDto getRegionWithFallback(SampleDto sample) {
//		if (sample.getRegion() == null) {
//			return sample.getResponsibleRegion();
//		}
//
//		return sample.getRegion();
//	}
