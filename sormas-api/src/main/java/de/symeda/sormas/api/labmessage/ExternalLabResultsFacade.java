...
public interface ExternalLabResultsFacade {
	 ...
	 * 
	 * @param message
	 * @return An ExternalMessageResult with a String that is a detailed HTML
	 *         representation of the original notification from the external lab
	 *         message server. This HTML must not exceed a width of 550px.
	 */
