...
public class FacilityExportDto implements Serializable {
	...
	public FacilityExportDto(String uuid, String name, FacilityType type, String region, String district,
			String community, String city, String postalCode, String street, String houseNumber,
			String additionalInformation, AreaType areaType, String contactPersonFirstName,
			String contactPersonLastName, String contactPersonPhone, String contactPersonEmail, Double latitude,
			Double longitude, String externalID) {
