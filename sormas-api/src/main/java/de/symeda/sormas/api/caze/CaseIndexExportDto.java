...
public class CaseIndexExportDto implements Serializable {
    ...
    //@formatter:off
    public CaseIndexExportDto(long id, String uuid, String epidNumber, String externalID, String externalToken, String internalToken, String personUuid, String personFirstName, String personLastName, Disease disease,
