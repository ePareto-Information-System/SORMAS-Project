...
public class LabMessageIndexDto implements Serializable {
	...
	public LabMessageIndexDto(String uuid, Date messageDateTime, String testLabName, String testLabPostalCode,
			Disease testedDisease, PathogenTestResultType testResult, String personFirstName, String personLastName,
			String personPostalCode, LabMessageStatus status) {
