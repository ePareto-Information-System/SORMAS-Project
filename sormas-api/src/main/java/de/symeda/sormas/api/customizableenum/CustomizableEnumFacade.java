...
public interface CustomizableEnumFacade {
     ...
     *
     * @param type  The type for which to retrieve the enum value
     * @param value The value used as the identifier in the database, identical to {@link CustomizableEnumValueDto#getValue()}
     * @param <T>   The specific extension of {@link CustomizableEnum} for type safety
     ...
     * @param type    The type for which to retrieve the enum value
     * @param value   The value used as the identifier in the database, identical to {@link CustomizableEnumValueDto#getValue()}
     * @param disease The disease for which to retrieve the enum values. If null, all enum values that are disease-independent are retrieved
     * @param <T>     The specific extension of {@link CustomizableEnum} for type safety
     * @return The enum instance containing its value, internationalized caption, and optional properties
     */
     ...
     *
     * @param type    The type for which to retrieve the enum values
     * @param disease The disease for which to retrieve the enum values. If null, all enum values that are disease-independent are retrieved
     * @param <T>     The specific extension of {@link CustomizableEnum} for type safety
