...
/**
 * Gateway to interact with the local external surveillance tool instance of the
 * health department
 */
@Remote
public interface ExternalSurveillanceToolFacade {
	...
	/**
	 * Requests the cases to be sent to the external surveillance tool configured in
	 * sormas.properties
	 * 
	 * @param caseUuids
