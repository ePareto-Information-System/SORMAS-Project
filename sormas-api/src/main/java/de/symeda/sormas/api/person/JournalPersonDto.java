...
public class JournalPersonDto implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return pseudonymized == that.pseudonymized && Objects.equals(uuid, that.uuid)
				&& Objects.equals(firstName, that.firstName) && Objects.equals(lastName, that.lastName)
				&& Objects.equals(emailAddress, that.emailAddress) && Objects.equals(phone, that.phone)
				&& Objects.equals(birthdateDD, that.birthdateDD) && Objects.equals(birthdateMM, that.birthdateMM)
				&& Objects.equals(birthdateYYYY, that.birthdateYYYY) && sex == that.sex
