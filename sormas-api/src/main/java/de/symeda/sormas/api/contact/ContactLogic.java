...
public final class ContactLogic {
	...
	/**
	 * Calculates the follow-up until date of the contact based on its start date
	 * (last contact or report date), the follow-up duration of the disease, the
	 ...
	 *                        contact start date, follow-up duration of the disease
	 *                        and date of the last cooperative visit. Ignores
	 *                        current follow-up until date and whether or not
	 *                        follow-up until has been overwritten.
	 */
	public static Date calculateFollowUpUntilDate(ContactDto contact, List<VisitDto> visits, int followUpDuration,
		...
		Date untilDate = !ignoreOverwrite && contact.isOverwriteFollowUpUntil() ? contact.getFollowUpUntil()
				: standardUntilDate;
