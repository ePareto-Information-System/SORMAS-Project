...
public final class StatisticsHelper {
	 ...
	 * @return
	 */
	 public static List<StatisticsGroupingKey> getTimeGroupingKeys(StatisticsCaseAttribute attribute, StatisticsSubAttribute subAttribute, CaseFacade caseFacade) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static List<StatisticsGroupingKey> getAttributeGroupingKeys(StatisticsCaseAttribute attribute, StatisticsSubAttribute subAttribute, DiseaseConfigurationFacade diseaseConfigurationFacade, CaseFacade caseFacade, RegionFacade regionFacade, DistrictFacade districtFacade) {
