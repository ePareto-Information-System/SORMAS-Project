...
public class StatisticsCaseSubAttribute {
	
	@SuppressWarnings("rawtypes")
	private final Enum _enum;	
	private StatisticsCaseSubAttributeEnum baseEnum;
	...
	@SuppressWarnings("rawtypes")
	public StatisticsCaseSubAttribute(Enum _enum, StatisticsCaseSubAttributeEnum baseEnum, boolean usedForFilters, boolean usedForGrouping, IValuesGetter valuesGetter) {
		this._enum = _enum;
	...
	public StatisticsCaseSubAttributeEnum getBaseEnum() {
		return baseEnum;
	}
	
	@SuppressWarnings("rawtypes")
	public static Enum getEnum (StatisticsCaseSubAttribute attribute) {
		return attribute == null ? null : attribute._enum;
	}
	
	public static StatisticsCaseSubAttributeEnum getBaseEnum (StatisticsCaseSubAttribute attribute) {
	...
	public interface IValuesGetter {
		Collection<? extends StatisticsGroupingKey> get(StatisticsCaseSubAttribute subAttribute, StatisticsAttribute attribute);
	}
}