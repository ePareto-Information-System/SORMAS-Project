...
public enum SymptomsList {
    ABDOMINAL, BLOODY_STOOL, CHILLS, CONVULSION, DEHYDRATION, DIARRHOEA, DIZZINESS, FEVER, EXCESSIVE_SWEATING, HEADACHE, JAUNDICE, NAUSEA, MUSCLE_ACHES, NUMBNESS, VOMITING, WEAKNESS, BODY_PAINS, LYMPH_NODES, RASH, SORE_THROAT, COUGH, FATIGUE, MACULAR, MACULOPAPULAR, VESICULAR, PAPULAR, PETECHIAL;
