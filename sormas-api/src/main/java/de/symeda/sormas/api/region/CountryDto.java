...
public class CountryDto extends EntityDto {
	...
	public CountryDto(Date creationDate, Date changeDate, String uuid, boolean archived, String defaultName,
			String externalId, String isoCode, String unoCode, String subcontinentUuid, String subcontinentName,
		...
		if (subcontinentUuid != null) {
			this.subcontinent = new SubcontinentReferenceDto(subcontinentUuid, subcontinentName,
					subcontinentExternalId);
		}
	}
