...
public class StatisticsCaseCriteria implements Serializable {
	...
	public StatisticsCaseCriteria years(List<Year> years, StatisticsCaseAttributeEnum mainAttribute) {
	...
	public StatisticsCaseCriteria quarters(List<Quarter> quarters, StatisticsCaseAttributeEnum mainAttribute) {
		switch (mainAttribute) {
		case ONSET_TIME:
	...
	public StatisticsCaseCriteria months(List<Month> months, StatisticsCaseAttributeEnum mainAttribute) {
		switch (mainAttribute) {
		case ONSET_TIME:
	...
	public StatisticsCaseCriteria epiWeeks(List<EpiWeek> epiWeeks, StatisticsCaseAttributeEnum mainAttribute) {
		switch (mainAttribute) {
		case ONSET_TIME:
	...
	public StatisticsCaseCriteria quartersOfYear(List<QuarterOfYear> quartersOfYear, StatisticsCaseAttributeEnum mainAttribute) {
		switch (mainAttribute) {
		case ONSET_TIME:
	...
	public StatisticsCaseCriteria monthsOfYear(List<MonthOfYear> monthsOfYear, StatisticsCaseAttributeEnum mainAttribute) {
		switch (mainAttribute) {
		case ONSET_TIME:
	...
	public StatisticsCaseCriteria epiWeeksOfYear(List<EpiWeek> epiWeeksOfYear, StatisticsCaseAttributeEnum mainAttribute) {
		switch (mainAttribute) {
		case ONSET_TIME:
	...
	public StatisticsCaseCriteria dateRange(Date from, Date to, StatisticsCaseAttributeEnum mainAttribute) {
		switch (mainAttribute) {
		case ONSET_TIME:
	...
	public StatisticsCaseCriteria reportingUserRoles(List<DefaultUserRole> reportingUserRoles2) {
		this.reportingUserRoles = reportingUserRoles2;
		return this;
	}
