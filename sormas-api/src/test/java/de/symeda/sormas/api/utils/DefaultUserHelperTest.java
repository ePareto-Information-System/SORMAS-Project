...
public class DefaultUserHelperTest {
	...
	private void testUsesDefaultPasswordHelper(String username, String defaultPassword) {
		...
		assertTrue(DefaultUserHelper.usesDefaultPassword(username, PasswordHelper.encodePassword(defaultPassword, seed),
				seed));
		assertFalse(
				DefaultUserHelper.usesDefaultPassword(username, PasswordHelper.encodePassword(randomPass, seed), seed));
	}
