...
public class StatisticsHelperTest {
	...
	public void testBuildGroupingKey() {
		...
		EpiWeek epiWeek = (EpiWeek) StatisticsHelper
			.buildGroupingKey(1803, StatisticsCaseAttribute.REPORT_TIME, StatisticsSubAttribute.EPI_WEEK_OF_YEAR, null, null, null, null);
		...
		MonthOfYear monthOfYear = (MonthOfYear) StatisticsHelper
			.buildGroupingKey(1811, StatisticsCaseAttribute.REPORT_TIME, StatisticsSubAttribute.MONTH_OF_YEAR, null, null, null, null);
		...
		QuarterOfYear quarterOfYear = (QuarterOfYear) StatisticsHelper
			.buildGroupingKey(182, StatisticsCaseAttribute.REPORT_TIME, StatisticsSubAttribute.QUARTER_OF_YEAR, null, null, null, null);
