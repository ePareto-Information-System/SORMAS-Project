...
public class UserRoleTest {
	...
	public void testUserRolesCombinationValidity() {
		...
		assertValidRolesCombination(UserRole.ADMIN, UserRole.NATIONAL_USER, UserRole.LAB_USER, UserRole.REST_USER,
				UserRole.REST_EXTERNAL_VISITS_USER, UserRole.IMPORT_USER);

		assertValidRolesCombination(UserRole.NATIONAL_USER, UserRole.NATIONAL_OBSERVER, UserRole.NATIONAL_CLINICIAN,
				UserRole.POE_NATIONAL_USER, UserRole.REST_EXTERNAL_VISITS_USER);
		...
		assertValidRolesCombination(UserRole.SURVEILLANCE_SUPERVISOR, UserRole.CASE_SUPERVISOR,
				UserRole.CONTACT_SUPERVISOR, UserRole.EVENT_OFFICER, UserRole.STATE_OBSERVER, UserRole.POE_SUPERVISOR);

		assertValidRolesCombination(UserRole.SURVEILLANCE_OFFICER, UserRole.CASE_OFFICER, UserRole.CONTACT_OFFICER,
	...
	public void testUserRolesJurisdiction() {
		...
		assertJurisdictionForRoles(JurisdictionLevel.NATION, UserRole.ADMIN, UserRole.REST_USER,
				UserRole.NATIONAL_CLINICIAN);
		assertJurisdictionForRoles(JurisdictionLevel.DISTRICT, UserRole.ADMIN, UserRole.REST_USER,
				UserRole.DISTRICT_OBSERVER);
