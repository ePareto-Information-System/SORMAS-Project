...
public class HtmlHelperTest {
	...
	public void testCleanHtmlAttribute() {
		...
		assertThat(HtmlHelper.cleanHtmlAttribute("title", "a < b & b < c = a < c"),
				equalTo("title='a &lt; b &amp; b &lt; c = a &lt; c'"));
	...
	public void testBuildHyperlinkTitle() {
		...
		assertThat(HtmlHelper.buildHyperlinkTitle("hoverText", "visualText"),
				equalTo("<a title=\"hoverText\">visualText</a>"));
		assertThat(HtmlHelper.buildHyperlinkTitle("transitive relation", "a < b & b < c = a < c"),
				equalTo("<a title=\"transitive relation\">a &lt; b &amp; b &lt; c = a &lt; c</a>"));
		assertThat(HtmlHelper.buildHyperlinkTitle("not <b>bold</b>", "not <i>italic</i>"),
				equalTo("<a title=\"not bold\">not italic</a>"));
		assertThat(
				HtmlHelper.buildHyperlinkTitle("tagContent' href=\"javascript:alert(1);\" class='",
						"breakout in title tag prevented"),
