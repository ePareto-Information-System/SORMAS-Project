!
    ...
    function(e, t) {
                ...
                exporting: {
                    ...
                    menuItemDefinitions: {
                        ...
                        downloadPNG: {
                            textKey: "downloadPNG",
                            onclick: function() {
                                window.downloadHtmlAsImage("image/png", "chart");
                                // this.exportChart()
                            }
                        },
                        downloadJPEG: {
                            ...
                            onclick: function() {
                                window.downloadHtmlAsImage("image/jpeg", "chart");
                                // this.exportChart({
                                //     type: "image/jpeg"
                                // })
                            }
                        ...
                        downloadPDF: {
                            textKey: "downloadPDF",
                            onclick: function() {
                                window.downloadPDF("downloaded-pdf")
                                // this.exportChart({
                        ...
                        downloadSVG: {
                            textKey: "downloadSVG",
                            onclick: function() {
                                window.downloadHtmlAsImage("image/svg+xml", "chart");
                                // this.exportChart({
                                //     type: "image/svg+xml"
                                // })
                            }
            ...
            open() {
                ...
                v(t, "fullscreenOpen", null, function() {
                    if (n && (e.origWidthOption = n.width, e.origHeightOption = n.height), e.origWidth = t.chartWidth, e.origHeight = t.chartHeight, e.browserProps) {
                        let n = b(t.container.ownerDocument, e.browserProps.fullscreenChange, function() {
            ...
            post: function(e, t, n) {
                ...
                return C.fetch(e, {
                    ...
                    e.ok && e.text().then(e => {
                        ...
                        t.href = `data:${r};base64,${e}`, t.download = o, t.click(), T(t)
                    })
                })
            }
        }, {
        ...
        ! function(e) {
            let t;
            let n = [/-/, /^(clipPath|cssText|d|height|width)$/, /^font$/, /[lL]ogical(Width|Height)$/, /^parentRule$/, /^(cssRules|ownerRules)$/, /perspective/, /TapHighlightColor/, /^transition/, /^length$/, /^\d+$/],
                i = ["fill", "stroke", "strokeLinecap", "strokeLinejoin", "strokeWidth", "textAnchor", "x", "y"];
            e.inlineAllowlist = [];
            ...
            function r(e) {
                ...
                }), r.text && r.symbol ? c.paddingLeft = z(c.paddingLeft, 30) : r.text || W(c, {
                    width: r.width,
                    height: r.height,
                    padding: 0
                });
                let p = o.button(r.text, 0, 0, n, c, void 0, void 0, void 0, void 0, r.useHTML).addClass(e.className).attr({
                    title: z(i.options.lang[r._titleKey || r.titleKey], "")
                });
            ...
            function s() {
                ...
                this.moveContainers(this.renderTo), [].forEach.call(e, function(e, t) {
            ...
            function l() {
                ...
                this.isPrinting = !0, this.pointer?.reset(void 0, 0), j(this, "beforePrint"), t && this.chartWidth > t && (n.resetParams = [this.options.chart.width, void 0, !1], this.setSize(t, void 0, !1)), [].forEach.call(n.childNodes, function(e, t) {
                    1 === e.nodeType && (n.origDisplay[t] = e.style.display, e.style.display = "none")
                }), this.moveContainers(e), this.printReverseInfo = n
            }

            function a(e) {
                e.renderExporting(), N(e, "redraw", e.renderExporting), N(e, "destroy", e.destroyExport)
            }
            ...
            function c(e, t, n, i, o, r, s) {
                let l = this,
                    ...
                    g = Math.max(o, r),
                    f, m = l[u];
                m || (l.exportContextMenu = l[u] = m = G("div", {
                    className: e
                }, {
                    position: "absolute",
                    zIndex: 1e3,
                    ...
                    pointerEvents: "auto",
                    ...l.renderer.style
                }, l.scrollablePlotArea?.fixedDiv || l.container), f = G("ul", {
                    className: "highcharts-menu"
                }, l.styledMode ? {} : {
                    listStyle: "none",
                    margin: 0,
                    padding: 0
                }, m), l.styledMode || D(f, W({
                    MozBoxShadow: "3px 3px 10px #888",
                    WebkitBoxShadow: "3px 3px 10px #888",
                    boxShadow: "3px 3px 10px #888"
                }, a.menuStyle)), m.hideMenu = function() {
                    D(m, {
                        display: "none"
                    }), s && s.setState(0), l.openMenu = !1, D(l.renderTo, {
                        overflow: "hidden"
                    }), D(l.container, {
                        overflow: "hidden"
                    }), h().clearTimeout(m.hideTimer), j(l, "exportMenuHidden")
                }, l.exportEvents.push(N(m, "mouseleave", function() {
                    ...
                    if ("string" == typeof e && (e = l.options.exporting.menuItemDefinitions[e]), q(e, !0)) {
                        let t;
                        e.separator ? t = G("hr", void 0, void 0, f) : ("viewData" === e.textKey && l.isDataTableVisible && (e.textKey = "hideData"), t = G("li", {
                            ...
                            cursor: "pointer"
                        }, a.menuItemStyle || {})))), l.exportDivElements.push(t)
                    }
                }), l.exportDivElements.push(f, m), l.exportMenuWidth = m.offsetWidth, l.exportMenuHeight = m.offsetHeight);
                let x = {
                    display: "block"
                };
                n + (l.exportMenuWidth || 0) > c ? x.right = c - n - o - g + "px" : x.left = n - g + "px", i + r + (l.exportMenuHeight || 0) > p && s.alignOptions?.verticalAlign !== "top" ? x.bottom = p - i - g + "px" : x.top = i + r - g + "px", D(m, x), D(l.renderTo, {
                    overflow: ""
                }), D(l.container, {
                    overflow: ""
                }), l.openMenu = !0, j(l, "exportMenuShown")
            }
            ...
            function p(e) {
                ...
                i && (i.forEach((e, o) => {
                    ...
                    e && (h().clearTimeout(e.hideTimer), L(e, "mouseleave"), o[t] = e.onmouseout = e.onmouseover = e.ontouchstart = e.onclick = null, I(e))
            ...
            function u(e, t) {
                ...
                e = V(this.options.exporting, e), F.post(e.url, {
            ...
            function b(e) {
                let t, n, i = V(this.options, e);
                i.plotOptions = V(this.userOptions.plotOptions, e && e.plotOptions), i.time = V(this.userOptions.time, e && e.time);
                let o = G("div", null, {
                        position: "absolute",
                        top: "-9999em",
                ...
                this.axes.forEach(function(e) {
                    e.userOptions.internalKey || (e.userOptions.internalKey = K()), e.options.isInternal || (c[e.coll] || (c[e.coll] = !0, i[e.coll] = []), i[e.coll].push(V(e.userOptions, {
                        visible: e.visible,
                        type: e.type,
                ...
                return e && ["xAxis", "yAxis", "series"].forEach(function(t) {
                    ...
                    let n = R(p.axes, e => e.options.internalKey === t.userOptions.internalKey);
                    if (n) {
                        let i = t.getExtremes(),
                            o = A(e?.[t.coll] || {})[0],
                ...
                }), t = p.getChartHTML(this.styledMode || i.exporting?.applyStyleSheets), j(this, "getSVG", {
                    chartCopy: p
                }), t = this.sanitizeSVG(t, i), i = null, p.destroy(), I(o), t
            }
                ...
                a && a.body.appendChild(a.createElementNS(k, "svg")),
                    function e(l) {
                        ...
                        if (a && 1 === l.nodeType && -1 === o.indexOf(l.nodeName)) {
                            if (c = H.getComputedStyle(l, null), p = "svg" === l.nodeName ? {} : H.getComputedStyle(l.parentNode, null), !s[l.nodeName]) {
                                t = a.getElementsByTagName("svg")[0], u = a.createElementNS(l.namespaceURI, l.nodeName), t.appendChild(u);
                                let e = H.getComputedStyle(u, null),
                                    n = {};
                                for (let t in e) t.length < 1e3 && "string" == typeof e[t] && !/^\d+$/.test(t) && (n[t] = e[t]);
                                s[l.nodeName] = n, "text" === l.nodeName && delete s.text.fill, t.removeChild(u)
                            }
                            for (let e in c)(h().isFirefox || h().isMS || h().isSafari || Object.hasOwnProperty.call(c, e)) && function(e, t) {
                                if (d = g = !1, r.length) {
                                    for (f = r.length; f-- && !g;) g = r[f].test(t);
                                    d = !g
                                }
                                for ("transform" === t && "none" === e && (d = !0), f = n.length; f-- && !d;) {
                                    if (t.length > 1e3) throw Error("Input too long");
                                    d = n[f].test(t) || "function" == typeof e
                                }!d && (p[t] !== e || "svg" === l.nodeName) && s[l.nodeName][t] !== e && (i && -1 === i.indexOf(t) ? m[t] = e : e && l.setAttribute(t.replace(/[A-Z]/g, function(e) {
                                    return "-" + e.toLowerCase()
                                }), e))
                            }(c[e], e);
                            if (D(l, m), "svg" === l.nodeName && l.setAttribute("stroke-width", "1px"), "text" === l.nodeName) return;
                            [].forEach.call(l.children || l.childNodes, e)
                        }
                    }(this.container.querySelector("svg")), t.parentNode.removeChild(t), l.parentNode.removeChild(l)
            }
            ...
            function C() {
                let e = this,
                    t = (t, n, i) => {
                        e.isDirtyExporting = !0, V(!0, e.options[t], n), z(i, !0) && e.redraw()
                    };
                e.exporting = {
                    update: function(e, n) {
                        t("exporting", e, n)
                ...
                let i = this.options.exporting,
                    {
                        ...
                        verticalAlign: s,
                        width: l = 0
                    } = V(this.options.navigation?.buttonOptions, i?.buttons?.contextButton),
                    a = e.width - n,
                    c = l + r;
                (i?.enabled ?? !0) && "title" === t && "right" === o && "top" === s && a < 2 * c && (a < c ? e.width -= c : this.title?.alignValue !== "left" && (e.x -= c - a / 2))
            }

            function O() {
                let e = this;
                e.isPrinting || (t = e, h().isSafari || e.beforePrint(), setTimeout(() => {
