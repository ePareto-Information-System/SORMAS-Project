...
public class SormasUI extends UI implements HasUserProvider, HasViewModelProviders {
	...
	private final static  String[][] caseBasedDiseases = {
			...
			{Disease.UNSPECIFIED_VHF.getName(), "data", "person", "hospitalization", "symptoms", "epidata", "samples"},
			...
			{Disease.FOODBORNE_ILLNESS.getName(), "data", "person", "hospitalization", "Food-History", "epidata", "60-Days", "Investigation-Notes"},
			{Disease.MONKEYPOX.getName(), "data", "person", "hospitalization", "symptoms", "riskFactor", "contacts", "samples"},
	};
