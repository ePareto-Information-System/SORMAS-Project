...
//
//public class ImportProgressLayout2 extends AbstractProgressLayout<ImportProgressUpdateInfo> {
//
...
//
//
//	public ImportProgressLayout2(int totalCount, UI currentUI, Runnable cancelCallback, boolean duplicatesPossible) {
//		this(totalCount, currentUI, cancelCallback, duplicatesPossible, true);
//	}
//
//	public ImportProgressLayout2(UI currentUI, int totalCount, Runnable cancelCallback, boolean showDuplicates) {
//		this(currentUI, totalCount, cancelCallback, showDuplicates, true);
//	}
//
//	public ImportProgressLayout2(UI currentUI, int totalCount, Runnable cancelCallback, boolean showDuplicates, boolean showSkips) {
//
...
//	}
//
//	public ImportProgressLayout2(UI currentUI, String initialInfoText, int totalCount, Runnable cancelCallback) {
//		super(currentUI, initialInfoText, totalCount, cancelCallback);
//	}
//
...
//	}
//
//	public ImportProgressLayout2(int totalCount, UI currentUI, Runnable cancelCallback, boolean duplicatesPossible, boolean skipPossible) {
//		super(currentUI, String.format(I18nProperties.getString(Strings.infoImportProcess), totalCount), totalCount, cancelCallback);
//
...
//
//
//	public ImportProgressLayout2(int totalCount, UI currentUI, Runnable cancelCallback, boolean duplicatesPossible, boolean skipPossible,boolean exportExcel) {
//		super(currentUI, String.format(I18nProperties.getString(Strings.infoImportProcess), totalCount), totalCount, cancelCallback);
//
//
//		this.totalCount = totalCount;
