...
public class MainScreen extends HorizontalLayout {
	...
	public MainScreen(SormasUI ui) {
		...
		if (permitted(FeatureType.CASE_SURVEILANCE, UserRight.STATISTICS_ACCESS)) {
			...
			//menu.addView(ContactStatisticsView.class, AbstractStatisticsView.ROOT_VIEW_NAME, I18nProperties.getCaption(Captions.mainMenuStatistics), VaadinIcons.BAR_CHART);
