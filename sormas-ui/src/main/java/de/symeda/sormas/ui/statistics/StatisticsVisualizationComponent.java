...
//	}
	...
	public StatisticsCaseAttributeEnum getRowsAttribute() {
		switch (visualizationType) {
		case MAP:
			//return statisticsAttributes.get(StatisticsAttributeEnum.REGION_DISTRICT);
			return StatisticsCaseAttributeEnum.JURISDICTION;
		default:
			break;
		}
...
//	public StatisticsCaseSubAttributeEnum getRowsSubAttribute() {
//		switch (visualizationType) {
//		case MAP:
//			switch (visualizationMapType) {
//			case REGIONS:
//				return statisticsAttributes.get(StatisticsCaseSubAttributeEnum.REGION);
//			case DISTRICTS:
//				return statisticsAttributes.get(StatisticsCaseSubAttributeEnum.DISTRICT);
//			default:
...
//	}
	...
	public StatisticsCaseSubAttributeEnum getRowsSubAttribute() {
		...
		case MAP:
			switch (visualizationMapType) {
			case REGIONS:
				return StatisticsCaseSubAttributeEnum.REGION;
			case DISTRICTS:
				return StatisticsCaseSubAttributeEnum.DISTRICT;
			default:
				throw new IllegalArgumentException(visualizationMapType.toString());
			}
		default:
	...
	public StatisticsCaseAttributeEnum getColumnsAttribute() {
		switch (visualizationType) {
		case MAP:
			return null;
		case CHART:
	...
	public StatisticsCaseSubAttributeEnum getColumnsSubAttribute() {
		switch (visualizationType) {
		case MAP:
			return null;
		case CHART:
	...
	public boolean hasRegionGrouping() {
		...
		case TABLE:
		case CHART:
			//return rowsElement.getSubAttributeEnum() == StatisticsCaseSubAttribute.REGION || columnsElement.getSubAttributeEnum() == StatisticsCaseSubAttribute.REGION;
			return rowsElement.getSubAttribute() == StatisticsCaseSubAttributeEnum.REGION
				|| columnsElement.getSubAttribute() == StatisticsCaseSubAttributeEnum.REGION;
		case MAP:
	...
	public boolean hasDistrictGrouping() {
		...
		case TABLE:
		case CHART:
			//return rowsElement.getSubAttributeEnum() == StatisticsCaseSubAttribute.DISTRICT || columnsElement.getSubAttributeEnum() == StatisticsCaseSubAttribute.DISTRICT;
			return rowsElement.getSubAttribute() == StatisticsCaseSubAttributeEnum.DISTRICT
				|| columnsElement.getSubAttribute() == StatisticsCaseSubAttributeEnum.DISTRICT;
		case MAP:
	...
	public boolean hasCommunityGrouping() {
		...
		case TABLE:
		case CHART:
			return rowsElement.getSubAttribute() == StatisticsCaseSubAttributeEnum.COMMUNITY
				|| columnsElement.getSubAttribute() == StatisticsCaseSubAttributeEnum.COMMUNITY;
	...
	public boolean hasIncidenceIncompatibleGrouping() {
		return rowsElement.getSubAttribute() == StatisticsCaseSubAttributeEnum.FACILITY
			|| columnsElement.getSubAttribute() == StatisticsCaseSubAttributeEnum.FACILITY;
	}
	...
	public boolean hasSexGrouping() {
		...
		case TABLE:
		case CHART:
			return rowsElement.getAttribute() == StatisticsCaseAttributeEnum.SEX || columnsElement.getAttribute() == StatisticsCaseAttributeEnum.SEX;
		case MAP:
			return false;
		default:
			throw new IllegalArgumentException(visualizationType.toString());
	...
	public boolean hasAgeGroupGroupingWithPopulationData() {
		...
		case CHART:
			...
			return rowsElement.getAttribute() == StatisticsCaseAttributeEnum.AGE_INTERVAL_5_YEARS
				|| columnsElement.getAttribute() == StatisticsCaseAttributeEnum.AGE_INTERVAL_5_YEARS;
		case MAP:
			return false;
		default:
			throw new IllegalArgumentException(visualizationType.toString());
	...
	public boolean hasAgeGroupGroupingWithoutPopulationData() {
		...
		case CHART:
			...
			return (rowsElement.getAttribute() != null
				...
				&& rowsElement.getAttribute() != StatisticsCaseAttributeEnum.AGE_INTERVAL_5_YEARS)
