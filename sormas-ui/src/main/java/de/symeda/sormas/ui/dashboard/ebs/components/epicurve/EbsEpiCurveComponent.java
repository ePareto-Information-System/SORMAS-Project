...
import de.symeda.sormas.ui.dashboard.ebs.components.epicurve.builders.EbsEpiCurveBuilder;
import de.symeda.sormas.ui.dashboard.ebs.components.epicurve.builders.EbsEpiCurveBuilders;
import de.symeda.sormas.ui.utils.CssStyles;

public class EbsEpiCurveComponent extends AbstractEpiCurveComponent<DashboardDataProvider> {

	private static final long serialVersionUID = 6582975657305031105L;

	private EbsEpiCurveMode epiCurveSurveillanceMode;

	public EbsEpiCurveComponent(DashboardDataProvider dashboardDataProvider) {
	...
	protected OptionGroup createEpiCurveModeSelector() {
		if (epiCurveSurveillanceMode == null) {
			epiCurveSurveillanceMode = EbsEpiCurveMode.CASE_STATUS;
		}
		...
		epiCurveModeOptionGroup.addItems((Object[]) EbsEpiCurveMode.values());
		...
		epiCurveModeOptionGroup.addValueChangeListener(e -> {
			epiCurveSurveillanceMode = (EbsEpiCurveMode) e.getProperty().getValue();
	...
	public void clearAndFillEpiCurveChart() {
		EbsEpiCurveBuilder surveillanceEpiCurveBuilder =
			EbsEpiCurveBuilders.getEpiCurveBuilder(epiCurveSurveillanceMode, epiCurveGrouping);
