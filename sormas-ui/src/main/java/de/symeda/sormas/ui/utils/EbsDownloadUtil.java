...
public class EbsDownloadUtil {

    public static StreamResource createEbsExportResource(
          EbsCriteria criteria,
        ...
        return DownloadUtil.createCsvExportStreamResource(
              EbsExportDto.class,
              null,
              (Integer start, Integer max) -> FacadeProvider.getEbsFacade()
                    .getExportList(criteria, selectedRows.get(), start, max),
              EbsDownloadUtil::captionProvider,
