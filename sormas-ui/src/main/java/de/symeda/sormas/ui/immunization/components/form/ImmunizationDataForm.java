...
public class ImmunizationDataForm extends AbstractEditForm<ImmunizationDto> {
	...
	protected void addFields() {
		...
		//ComboBox dhimsFacilityType = addField(ImmunizationDto.DHIMS_FACILITY_TYPE);
		...
		responsibleCommunityCombo.addValueChangeListener(e -> {
			...
			if (facilityType.getValue() != null) {
				FieldHelper.updateItems(
					...
					communityDto != null
						? FacadeProvider.getFacilityFacade()
							.getActiveFacilitiesByCommunityAndType(communityDto, (FacilityType) facilityType.getValue(), true, false, true, true)
