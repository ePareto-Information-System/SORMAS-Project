...
//        if (create) { 1.87.0 and commented out in 1.74
...
//        }
    ...
    protected void addFields() {
        ...
        district.addValueChangeListener(e -> {
            ...
            FieldHelper.updateItems(
                    healthFacility,
                    districtDto != null ? FacadeProvider.getFacilityFacade().getActiveHospitalsByDistrict(districtDto, false, false, true) : null);
            FieldHelper.updateItems(
                    associatedOfficer,
