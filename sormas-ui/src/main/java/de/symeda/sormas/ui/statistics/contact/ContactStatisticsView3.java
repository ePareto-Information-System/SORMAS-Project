...
//import de.symeda.sormas.ui.statistics.StatisticsFilterJurisdictionElement;
//import de.symeda.sormas.ui.statistics.StatisticsFilterResidenceElement;
...
//import de.symeda.sormas.ui.statistics.caze.StatisticsCaseGrid;
//import de.symeda.sormas.ui.utils.ButtonHelper;
//import de.symeda.sormas.ui.utils.CssStyles;
//import de.symeda.sormas.ui.utils.DownloadUtil;
//import de.symeda.sormas.ui.utils.ExportEntityName;
//
//public class ContactStatisticsView3 extends AbstractStatisticsView {
//
...
//	private  Label emptyResultLabel;
...
//
//	
////	public ContactStatisticsView(String viewName) {
////		super(viewName);
////		setWidth(100, Unit.PERCENTAGE);
////
////		emptyResultLabel = new Label(I18nProperties.getString(Strings.infoNoCasesFoundStatistics));
...
////
////		setVisualizationComponent(new StatisticsVisualizationComponent(statisticsAttributes));
////		CssStyles.style(getVisualizationComponent(), CssStyles.STATISTICS_TITLE_BOX);
////		statisticsLayout.addComponent(getVisualizationComponent());
////		getVisualizationComponent().addVisualizationTypeChangedListener(visualizationType -> {
////			cbHideOtherCountries.setVisible(StatisticsVisualizationType.MAP.equals(visualizationType));
////		});
////
////		// Options layout
...
//				getVisualizationComponent().setStackedColumnAndPieEnabled(!showCaseIncidence);
//			});
...
//				if (filterComponent.getSelectedAttribute() != StatisticsCaseAttributeEnum.JURISDICTION
//					&& filterComponent.getSelectedAttribute() != StatisticsCaseAttributeEnum.PLACE_OF_RESIDENCE
//					&& (filterComponent.getSelectedAttribute() == null
...
//		StatisticsCaseAttributeEnum xAxisAttribute = getVisualizationComponent().getColumnsAttribute();
//		StatisticsCaseSubAttributeEnum xAxisSubAttribute = getVisualizationComponent().getColumnsSubAttribute();
//		StatisticsCaseAttributeEnum seriesAttribute = getVisualizationComponent().getRowsAttribute();
//		StatisticsCaseSubAttributeEnum seriesSubAttribute = getVisualizationComponent().getRowsSubAttribute();
//
...
//	}
//
//	//protected abstract List<StatisticsCaseCountDto> generateStatistics();
//	
//	//protected abstract List<StatisticsContactCountDto> generateContactStatistics();
//
//	
...
//		for (StatisticsFilterComponent filterComponent : filterComponents) {
//			if (filterComponent.getSelectedAttribute() == StatisticsCaseAttributeEnum.SEX
//				|| filterComponent.getSelectedAttribute() == StatisticsCaseAttributeEnum.AGE_INTERVAL_5_YEARS) {
...
//			if (filterComponent.getSelectedAttribute() == StatisticsCaseAttributeEnum.AGE_INTERVAL_1_YEAR
//				|| filterComponent.getSelectedAttribute() == StatisticsCaseAttributeEnum.AGE_INTERVAL_BASIC
//				|| filterComponent.getSelectedAttribute() == StatisticsCaseAttributeEnum.AGE_INTERVAL_CHILDREN_COARSE
//				|| filterComponent.getSelectedAttribute() == StatisticsCaseAttributeEnum.AGE_INTERVAL_CHILDREN_MEDIUM
//				|| filterComponent.getSelectedAttribute() == StatisticsCaseAttributeEnum.AGE_INTERVAL_CHILDREN_FINE) {
//				return true;
//			}
//		}
//
...
//	}
//
//	protected <T extends StatisticsGroupingKey> Integer calculateMaximumReferenceYear(
...
//	}
//
//	private void fillContactCriteria(boolean showCaseIncidence) {
//		contactCriteria = new StatisticsCaseCriteria();
//
//		for (StatisticsFilterComponent filterComponent : filterComponents) {
...
//					}
//					contactCriteria.outcomes(outcomes);
//				}
//				break;
...
//					}
//					contactCriteria.healthFacilities(facilities);
//				}
//				break;
...
//	}
//
//	public StatisticsVisualizationComponent getVisualizationComponent() {
//		return visualizationComponent;
//	}
//
//	public void setVisualizationComponent(StatisticsVisualizationComponent visualizationComponent) {
...
//				criteria,
//				StatisticsHelper.getEnum(getVisualizationComponent().getRowsAttribute()), 
//				StatisticsHelper.getBaseEnum(getVisualizationComponent().getRowsSubAttribute()),
//				StatisticsHelper.getEnum(getVisualizationComponent().getColumnsAttribute()), 
//				StatisticsHelper.getBaseEnum(getVisualizationComponent().getColumnsSubAttribute()),
