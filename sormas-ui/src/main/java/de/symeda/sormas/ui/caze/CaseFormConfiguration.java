...
public class CaseFormConfiguration {
    ...
    static {
        ...
        DISABLED_FIELDS_BY_DISEASE.put(CaseDataDto.REGION, new HashSet<>(Arrays.asList()));
        DISABLED_FIELDS_BY_DISEASE.put(CaseDataDto.DISTRICT, new HashSet<>(Arrays.asList()));
        DISABLED_FIELDS_BY_DISEASE.put(CaseDataDto.COMMUNITY, new HashSet<>(Arrays.asList()));
        ...
        DISABLED_FIELDS_BY_DISEASE.put(MEDICAL_INFORMATION_LOC, new HashSet<>(Arrays.asList()));
        DISABLED_FIELDS_BY_DISEASE.put(CaseDataDto.BLOOD_ORGAN_OR_TISSUE_DONATED, new HashSet<>(Arrays.asList()));
        DISABLED_FIELDS_BY_DISEASE.put(CaseDataDto.PREGNANT, new HashSet<>(Arrays.asList(Disease.YELLOW_FEVER, Disease.CSM, Disease.MEASLES)));
        DISABLED_FIELDS_BY_DISEASE.put(CaseDataDto.POSTPARTUM, new HashSet<>(Arrays.asList(Disease.YELLOW_FEVER, Disease.CSM, Disease.MEASLES)));
        ...
        DISABLED_FIELDS_BY_DISEASE.put(CaseDataDto.FOLLOW_UP_STATUS, new HashSet<>(Arrays.asList(Disease.YELLOW_FEVER,Disease.AFP, Disease.NEW_INFLUENZA, Disease.AHF, Disease.CSM)));
        DISABLED_FIELDS_BY_DISEASE.put(CaseDataDto.FOLLOW_UP_STATUS_CHANGE_DATE, new HashSet<>(Arrays.asList(Disease.YELLOW_FEVER,Disease.AFP, Disease.NEW_INFLUENZA, Disease.AHF, Disease.CSM)));
        DISABLED_FIELDS_BY_DISEASE.put(CaseDataDto.FOLLOW_UP_STATUS_CHANGE_USER, new HashSet<>(Arrays.asList(Disease.YELLOW_FEVER,Disease.AFP, Disease.NEW_INFLUENZA, Disease.AHF, Disease.CSM)));
        DISABLED_FIELDS_BY_DISEASE.put(CaseDataDto.FOLLOW_UP_UNTIL, new HashSet<>(Arrays.asList(Disease.YELLOW_FEVER,Disease.AFP, Disease.NEW_INFLUENZA, Disease.AHF, Disease.CSM)));
        DISABLED_FIELDS_BY_DISEASE.put(CaseDataDto.OVERWRITE_FOLLOW_UP_UNTIL, new HashSet<>(Arrays.asList(Disease.YELLOW_FEVER,Disease.AFP, Disease.NEW_INFLUENZA, Disease.AHF, Disease.CSM)));
        DISABLED_FIELDS_BY_DISEASE.put(CaseDataDto.FOLLOW_UP_COMMENT, new HashSet<>(Arrays.asList(Disease.YELLOW_FEVER,Disease.AFP, Disease.NEW_INFLUENZA, Disease.AHF, Disease.CSM)));
        ...
        DISABLED_FIELDS_BY_DISEASE.put(CaseDataDto.REPORTING_OFFICER_TITLE, new HashSet<>(Arrays.asList(Disease.AFP, Disease.NEW_INFLUENZA, Disease.AHF)));
        DISABLED_FIELDS_BY_DISEASE.put(CaseDataDto.FUNCTION_OF_REPORTING_OFFICER, new HashSet<>(Arrays.asList(Disease.AFP, Disease.NEW_INFLUENZA, Disease.AHF)));
        DISABLED_FIELDS_BY_DISEASE.put(CaseDataDto.REPORTING_OFFICER_CONTACT_PHONE, new HashSet<>(Arrays.asList(Disease.AFP, Disease.NEW_INFLUENZA, Disease.AHF)));
        DISABLED_FIELDS_BY_DISEASE.put(CaseDataDto.REPORTING_OFFICER_EMAIL, new HashSet<>(Arrays.asList(Disease.CSM, Disease.AFP, Disease.NEW_INFLUENZA, Disease.AHF)));
        ...
        DISABLED_FIELDS_BY_DISEASE.put(CaseDataDto.NATIONAL_LEVEL_DATE, new HashSet<>(Arrays.asList()));
