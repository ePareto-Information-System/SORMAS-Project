...
//									CaseDataDto.RABIES_TYPE))) +
					...
					fluidRowLocs(CaseDataDto.VACCINATION_STATUS, CaseDataDto.LAST_DATE_OF_VACCINATION) +
	...
	protected void addFields() {
		...
		addField(CaseDataDto.CASE_TRANSMISSION_CLASSIFICATION, OptionGroup.class);
		...
		diseaseField.addValueChangeListener((ValueChangeListener) valueChangeEvent -> {
			...
			if (disease != null && Arrays.asList(Disease.YELLOW_FEVER, Disease.MEASLES, Disease.ANTHRAX, Disease.DENGUE, Disease.PLAGUE, Disease.RABIES).contains(disease)) {
				FieldHelper.setVisibleWhen(
						getFieldGroup(),
