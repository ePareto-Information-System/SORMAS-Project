...
public class StatisticsContactGrid extends Grid{
	...
	public StatisticsContactGrid(
		StatisticsContactAttributeEnum rowsAttribute,
		StatisticsContactSubAttributeEnum statisticsContactSubAttributeEnum,
		StatisticsContactAttributeEnum columnsAttribute,
		StatisticsContactSubAttributeEnum statisticsContactSubAttributeEnum2,
		...
		if (columnsAttribute == null && statisticsContactSubAttributeEnum2 == null) {
