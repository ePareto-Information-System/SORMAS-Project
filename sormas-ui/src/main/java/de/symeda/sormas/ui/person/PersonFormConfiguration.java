...
public class PersonFormConfiguration {
    ...
    static {
        // Associate diseases with fields
            ...
            DISABLED_FIELDS_BY_DISEASE.put(PersonDto.PRESENT_CONDITION, new HashSet<>(Arrays.asList(Disease.FOODBORNE_ILLNESS, Disease.IMMEDIATE_CASE_BASED_FORM_OTHER_CONDITIONS, Disease.NEW_INFLUENZA, Disease.AHF, Disease.YELLOW_FEVER)));
            ...
            DISABLED_FIELDS_BY_DISEASE.put(PersonDto.EDUCATION_TYPE, new HashSet<>(Arrays.asList(Disease.AFP, Disease.CSM, Disease.IMMEDIATE_CASE_BASED_FORM_OTHER_CONDITIONS, Disease.AHF, Disease.FOODBORNE_ILLNESS)));
