...
public class PersonFormConfiguration {
    ...
    static {
        // Associate diseases with fields
            ...
            DISABLED_FIELDS_BY_DISEASE.put(PersonDto.PRESENT_CONDITION, new HashSet<>(Arrays.asList(Disease.FOODBORNE_ILLNESS, Disease.IMMEDIATE_CASE_BASED_FORM_OTHER_CONDITIONS, Disease.NEW_INFLUENZA, Disease.UNSPECIFIED_VHF, Disease.YELLOW_FEVER)));
            ...
            DISABLED_FIELDS_BY_DISEASE.put(PersonDto.NUMBER_OF_PEOPLE, new HashSet<>(Arrays.asList(Disease.CSM, Disease.NEW_INFLUENZA, Disease.SARI, Disease.AFP, Disease.YELLOW_FEVER, Disease.UNSPECIFIED_VHF)));
            DISABLED_FIELDS_BY_DISEASE.put(PersonDto.NUMBER_OF_OTHER_CONTACTS, new HashSet<>(Arrays.asList(Disease.CSM, Disease.NEW_INFLUENZA, Disease.SARI, Disease.AFP, Disease.YELLOW_FEVER, Disease.UNSPECIFIED_VHF)));
            ...
            DISABLED_FIELDS_BY_DISEASE.put(PersonDto.OCCUPATION_DETAILS, new HashSet<>(Arrays.asList(Disease.IMMEDIATE_CASE_BASED_FORM_OTHER_CONDITIONS, Disease.UNSPECIFIED_VHF)));
            ...
            DISABLED_FIELDS_BY_DISEASE.put(PersonDto.EDUCATION_TYPE, new HashSet<>(Arrays.asList(Disease.AFP, Disease.CSM, Disease.IMMEDIATE_CASE_BASED_FORM_OTHER_CONDITIONS, Disease.UNSPECIFIED_VHF, Disease.FOODBORNE_ILLNESS)));
            ...
            DISABLED_FIELDS_BY_DISEASE.put(PersonDto.BIRTH_COUNTRY, new HashSet<>(Arrays.asList(Disease.UNSPECIFIED_VHF, Disease.AFP)));
