...
public class StatisticsCaseGrid extends Grid {
	...
	public StatisticsCaseGrid(
		StatisticsCaseAttributeEnum statisticsCaseAttributeEnum,
		StatisticsCaseSubAttributeEnum statisticsCaseSubAttributeEnum,
		StatisticsCaseAttributeEnum statisticsCaseAttributeEnum2,
		StatisticsCaseSubAttributeEnum statisticsCaseSubAttributeEnum2,
		...
		if (statisticsCaseAttributeEnum == null && statisticsCaseAttributeEnum2 == null) {
		...
		if (statisticsCaseAttributeEnum2 == null && statisticsCaseSubAttributeEnum2 == null) {
			...
			if (addColumnUnknown && statisticsCaseAttributeEnum2.isUnknownValueAllowed()) {
		...
		for (StatisticsCaseCountDto cellValue : cellValues) {
			...
			if (currentRow != null && !DataHelper.equal(currentRowKey, cellValue.getRowKey())) {
				...
				if (statisticsCaseAttributeEnum2 != null) {
					// Calculate total
					if (rowTotal == 0) {
					...
					if (!(showCaseIncidence && rowPopulation == 0)) {
						...
						if (statisticsCaseAttributeEnum != null && statisticsCaseAttributeEnum.isPopulationData()) {
			...
			if (cellValue.getPopulation() != null) {
				if (statisticsCaseAttributeEnum2 != null && statisticsCaseAttributeEnum2.isPopulationData()) {
	...
	public StatisticsCaseGrid(StatisticsCaseAttribute rowsAttribute, StatisticsCaseSubAttribute rowsSubAttribute,
			...
			boolean showCaseIncidence, int incidenceDivisor, List<StatisticsCaseCountDto> resultData,
			StatisticsCaseCriteria caseCriteria) {
