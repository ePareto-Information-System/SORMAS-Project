...
public class EpiFormConfiguration {
    ...
    static {
        ...
        DISABLED_FIELDS_BY_DISEASE.put(EpiDataDto.EXPOSURE_DETAILS_KNOWN, new HashSet<>(Arrays.asList(Disease.AFP, Disease.IMMEDIATE_CASE_BASED_FORM_OTHER_CONDITIONS)));
        DISABLED_FIELDS_BY_DISEASE.put(EpiDataDto.EXPOSURES, new HashSet<>(Arrays.asList(Disease.AFP, Disease.IMMEDIATE_CASE_BASED_FORM_OTHER_CONDITIONS)));
        DISABLED_FIELDS_BY_DISEASE.put(EpiDataDto.ACTIVITY_AS_CASE_DETAILS_KNOWN, new HashSet<>(Arrays.asList(Disease.AFP, Disease.IMMEDIATE_CASE_BASED_FORM_OTHER_CONDITIONS)));
        DISABLED_FIELDS_BY_DISEASE.put(EpiDataDto.ACTIVITIES_AS_CASE, new HashSet<>(Arrays.asList(Disease.AFP, Disease.IMMEDIATE_CASE_BASED_FORM_OTHER_CONDITIONS)));
        DISABLED_FIELDS_BY_DISEASE.put(EpiDataDto.HIGH_TRANSMISSION_RISK_AREA, new HashSet<>(Arrays.asList(Disease.AFP, Disease.IMMEDIATE_CASE_BASED_FORM_OTHER_CONDITIONS)));
        DISABLED_FIELDS_BY_DISEASE.put(EpiDataDto.LARGE_OUTBREAKS_AREA, new HashSet<>(Arrays.asList(Disease.AFP, Disease.IMMEDIATE_CASE_BASED_FORM_OTHER_CONDITIONS)));
        DISABLED_FIELDS_BY_DISEASE.put(EpiDataDto.AREA_INFECTED_ANIMALS, new HashSet<>(Arrays.asList(Disease.AFP, Disease.IMMEDIATE_CASE_BASED_FORM_OTHER_CONDITIONS)));
        DISABLED_FIELDS_BY_DISEASE.put(EpiDataDto.CONTACT_WITH_SOURCE_CASE_KNOWN, new HashSet<>(Arrays.asList(Disease.AFP, Disease.IMMEDIATE_CASE_BASED_FORM_OTHER_CONDITIONS)));
    }
