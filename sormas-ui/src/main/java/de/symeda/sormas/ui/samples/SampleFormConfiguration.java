...
public class SampleFormConfiguration {
    ...
    static {
        DISABLED_FIELDS_BY_DISEASE.put(SampleDto.PATHOGEN_TESTING_REQUESTED, new HashSet<>(Arrays.asList(Disease.NEW_INFLUENZA, Disease.CSM, Disease.UNSPECIFIED_VHF)));
        DISABLED_FIELDS_BY_DISEASE.put(SampleDto.SAMPLE_PURPOSE, new HashSet<>(Arrays.asList(Disease.AFP, Disease.UNSPECIFIED_VHF)));
        DISABLED_FIELDS_BY_DISEASE.put(SampleDto.REQUESTED_SAMPLE_MATERIALS, new HashSet<>(Arrays.asList(Disease.AFP, Disease.UNSPECIFIED_VHF)));
        DISABLED_FIELDS_BY_DISEASE.put(SampleDto.FIELD_SAMPLE_ID, new HashSet<>());
        DISABLED_FIELDS_BY_DISEASE.put(SampleDto.SAMPLE_MATERIAL_TEXT, new HashSet<>(Arrays.asList(Disease.AFP, Disease.YELLOW_FEVER)));
        DISABLED_FIELDS_BY_DISEASE.put(SampleDto.SAMPLE_MATERIAL_REQUESTED, new HashSet<>(Arrays.asList(Disease.AFP, Disease.UNSPECIFIED_VHF)));
        DISABLED_FIELDS_BY_DISEASE.put(SampleDto.COMMENT, new HashSet<>(Arrays.asList(Disease.AFP, Disease.UNSPECIFIED_VHF)));
        DISABLED_FIELDS_BY_DISEASE.put(SampleDto.SAMPLING_REASON, new HashSet<>(Arrays.asList(Disease.AFP, Disease.UNSPECIFIED_VHF, Disease.YELLOW_FEVER)));
        ...
        DISABLED_FIELDS_BY_DISEASE.put(SampleDto.SAMPLE_SOURCE, new HashSet<>(Arrays.asList(Disease.AFP, Disease.UNSPECIFIED_VHF, Disease.YELLOW_FEVER)));
