...
public class SymptomsForm extends AbstractEditForm<SymptomsDto> {
	...
	protected void addFields() {
		...
		if(disease == Disease.CSM){
			...
			symptomsHide();
			setVisible(true, FEVER, RAPID_BREATHING, MUSCLE_PAIN, CHEST_PAIN, ABDOMINAL_PAIN, JOINT_PAIN, WEAKNESS, DIARRHEA, COUGH, NAUSEA, SORE_THROAT, HEADACHE, RUNNY_NOSE, HEADACHE, CONFUSED_DISORIENTED, OTHER_COMPLICATIONS, PHARYNGEAL_EXUDATE, COMA, ABNORMAL_LUNG_XRAY_FINDINGS, CONJUNCTIVAL_INJECTION, SEIZURES, FLUID_IN_LUNG_CAVITY_AUSCULTATION);
		}
