...
public class CaseStatisticsView extends AbstractStatisticsView {
	...
	//protected StatisticsCaseAttributesContainer statisticsAttributes;
...
//	public CaseStatisticsView(String viewName) {
//		super(viewName);
//		setWidth(100, Unit.PERCENTAGE);
//
//		emptyResultLabel = new Label(I18nProperties.getString(Strings.infoNoCasesFoundStatistics));
