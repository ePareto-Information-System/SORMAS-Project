...
//	private static final Object CASE_COUNT_OR_INCIDENCE_COLUMN = "CountOrIncidenceColumn";
//	
...
//			StatisticsAttribute columnsAttribute, StatisticsSubAttribute columnsSubAttribute, boolean b,
//			int incidenceDivisor, List<StatisticsCaseCountDto> resultData, StatisticsCaseCriteria caseCriteria) {
//	}
//
//	/**
//	 * @param cellValues
//	 *            Ordered by rows, then columns
//	 * @param defaultColumnCaption 
//	 * @param caseCountTotalRow 
//	 * @param showIncidence 
//	 * @return 
//	 */
...
//	public void StatisticsCaseGrid(
...
//		StatisticsCaseCriteria caseCriteria, String defaultColumnCaption, int[] caseCountTotalRow, boolean showIncidence) {
//
//		//super(); uncomment
//
...
//		//setCellStyleGenerator(new StatisticsGridCellStyleGenerator()); uncomment
//
...
//			}
//
//			if (cellValue.getCaseCount() != null && !(showIncidence && cellValue.getPopulation() == null)) {
//				// Don't add to case sum when we are looking at incidence and population is not provided 
//				rowTotal += cellValue.getCaseCount();
//				countTotalRow[columnIndex] += cellValue.getCaseCount();
//			}
//
