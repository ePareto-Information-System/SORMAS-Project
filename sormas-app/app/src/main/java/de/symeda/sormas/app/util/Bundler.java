...
public class Bundler {
	...
	public Bundler setEbsUuid(String ebsUuid) {
		bundle.putString(EBS_UUID, ebsUuid);
		return this;
	}
	...
	public String getTriagingUuid() {
		if (bundle.containsKey(TRIAGING_UUID)) {
			return bundle.getString(TRIAGING_UUID);
		}
		return null;
	}
