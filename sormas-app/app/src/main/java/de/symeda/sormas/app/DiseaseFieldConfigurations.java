...
public class DiseaseFieldConfigurations {
    ...
    static {
        ...
        diseaseFieldConfigurations.put(new DiseaseFormTypeKey(Disease.YELLOW_FEVER, FormType.CASE_CREATE),
                Arrays.asList(
                        R.id.caseData_disease, R.id.caseData_caseOrigin, R.id.caseData_epidNumber, R.id.caseData_headingCaseResponsibleJurisidction, R.id.caseData_responsibleCommunity, R.id.caseData_healthFacility, R.id.caseData_healthFacilityDetails,
                        R.id.name_fields_layout, R.id.caseData_otherName, R.id.person_birthdateLabel, R.id.person_sex, R.id.person_ghanaCard,
