...
package de.symeda.sormas.app.triaging;
...
public enum TriagingSection
	...
	TriagingSection(int friendlyNameResourceId, int iconResourceId) {
		this.friendlyNameResourceId = friendlyNameResourceId;
		this.iconResourceId = iconResourceId;
	}

	public static TriagingSection fromOrdinal(int ordinal) {
		return TriagingSection.values()[ordinal];
	}
