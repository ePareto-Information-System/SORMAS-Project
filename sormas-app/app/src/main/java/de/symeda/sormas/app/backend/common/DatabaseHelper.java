...
//				 Recreate immunization table because unique constraint was not taking snapshot into account
			...
			case 336:
				currentVersion = 336;
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN generalBodilyPains varchar(255);");
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN lesionsNeck boolean;");
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN lesionsTrunk boolean;");
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN rashes varchar(255);");
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN macularRash varchar(255);");
				getDao(Symptoms.class).executeRaw("ALTER TABLE symptoms ADD COLUMN papularRash varchar(255);");
...
//				getDao(DiseaseConfiguration.class).executeRaw("ALTER TABLE tmp_diseaseConfiguration ADD COLUMN caseBased boolean;");
			...
			case 361:
				currentVersion = 361;
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN reportingVillage varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN reportingZone varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN investigationOfficerName varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN investigationOfficerPosition varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN formCompletedByName varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN formCompletedByPosition varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN formCompletedByCellPhoneNo varchar(255);");
				getDao(Case.class).executeRaw("ALTER TABLE cases ADD COLUMN dateOfInvestigation timestamp;");
...
//				remove code causing database to be locked
			...
			case 392:
				...
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN discordant VARCHAR(255);");
				getDao(Sample.class).executeRaw("ALTER TABLE samples ADD COLUMN finalLabResults DATE;");
			...
			case 395:
				...
				getDao(RiskFactor.class).executeRaw("ALTER TABLE riskfactor ADD COLUMN during3WeeksPatientContactWithSimilarSymptomsIfYes varchar(255);");
			...
			case 397:
				currentVersion = 397;
				getDao(InvestigationNotes.class).executeRaw("ALTER TABLE investigationnotes ADD surname varchar(255)");
				getDao(InvestigationNotes.class).executeRaw("ALTER TABLE investigationnotes ADD firstName varchar(255)");
				getDao(InvestigationNotes.class).executeRaw("ALTER TABLE investigationnotes ADD middleName varchar(255)");
				getDao(InvestigationNotes.class).executeRaw("ALTER TABLE investigationnotes ADD telNo varchar(255)");
				getDao(InvestigationNotes.class).executeRaw("ALTER TABLE investigationnotes ADD dateOfCompletionOfForm Date");
				getDao(InvestigationNotes.class).executeRaw("ALTER TABLE investigationnotes ADD nameOfHealthFacility varchar(255)");
			...
			case 406:
				currentVersion = 406;
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET fever = NULL WHERE fever = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET vomiting = NULL WHERE vomiting = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET diarrhea = NULL WHERE diarrhea = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET bloodInStool = NULL WHERE bloodInStool = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET nausea = NULL WHERE nausea = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET abdominalPain = NULL WHERE abdominalPain = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET headache = NULL WHERE headache = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET musclePain = NULL WHERE musclePain = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET fatigueWeakness = NULL WHERE fatigueWeakness = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET unexplainedBleeding = NULL WHERE unexplainedBleeding = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET gumsBleeding = NULL WHERE gumsBleeding = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET injectionSiteBleeding = NULL WHERE injectionSiteBleeding = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET noseBleeding = NULL WHERE noseBleeding = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET bloodyBlackStool = NULL WHERE bloodyBlackStool = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET redBloodVomit = NULL WHERE redBloodVomit = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET digestedBloodVomit = NULL WHERE digestedBloodVomit = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET coughingBlood = NULL WHERE coughingBlood = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET bleedingVagina = NULL WHERE bleedingVagina = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET skinBruising = NULL WHERE skinBruising = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET bloodUrine = NULL WHERE bloodUrine = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET skinRash = NULL WHERE skinRash = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET generalizedRash = NULL WHERE generalizedRash = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET neckStiffness = NULL WHERE neckStiffness = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET soreThroat = NULL WHERE soreThroat = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET cough = NULL WHERE cough = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET coughWithSputum = NULL WHERE coughWithSputum = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET coughWithHeamoptysis = NULL WHERE coughWithHeamoptysis = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET runnyNose = NULL WHERE runnyNose = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET difficultyBreathing = NULL WHERE difficultyBreathing = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET chestPain = NULL WHERE chestPain = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET conjunctivitis = NULL WHERE conjunctivitis = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET eyePainLightSensitive = NULL WHERE eyePainLightSensitive = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET kopliksSpots = NULL WHERE kopliksSpots = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET throbocytopenia = NULL WHERE throbocytopenia = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET otitisMedia = NULL WHERE otitisMedia = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET hearingloss = NULL WHERE hearingloss = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET dehydration = NULL WHERE dehydration = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET anorexiaAppetiteLoss = NULL WHERE anorexiaAppetiteLoss = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET refusalFeedorDrink = NULL WHERE refusalFeedorDrink = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET jointPain = NULL WHERE jointPain = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET hiccups = NULL WHERE hiccups = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET backache = NULL WHERE backache = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET eyesBleeding = NULL WHERE eyesBleeding = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET jaundice = NULL WHERE jaundice = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET darkUrine = NULL WHERE darkUrine = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET stomachBleeding = NULL WHERE stomachBleeding = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET rapidBreathing = NULL WHERE rapidBreathing = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET swollenGlands = NULL WHERE swollenGlands = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET cutaneousEruption = NULL WHERE cutaneousEruption = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET lesions = NULL WHERE lesions = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET rashes = NULL WHERE rashes = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET vesicularRash = NULL WHERE vesicularRash = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET macularRash = NULL WHERE macularRash = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET papularRash = NULL WHERE papularRash = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET lesionsThatItch = NULL WHERE lesionsThatItch = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET lesionsSameState = NULL WHERE lesionsSameState = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET lesionsSameSize = NULL WHERE lesionsSameSize = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET lesionsDeepProfound = NULL WHERE lesionsDeepProfound = 'UNKNOWN'");
				...
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET lymphadenopathy = NULL WHERE lymphadenopathy = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET lymphadenopathyInguinal = NULL WHERE lymphadenopathyInguinal = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET lymphadenopathyAxillary = NULL WHERE lymphadenopathyAxillary = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET lymphadenopathyCervical = NULL WHERE lymphadenopathyCervical = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET chillsSweats = NULL WHERE chillsSweats = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET bedridden = NULL WHERE bedridden = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET oralUlcers = NULL WHERE oralUlcers = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET painfulLymphadenitis = NULL WHERE painfulLymphadenitis = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET buboesGroinArmpitNeck = NULL WHERE buboesGroinArmpitNeck = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET blackeningDeathOfTissue = NULL WHERE blackeningDeathOfTissue = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET bulgingFontanelle = NULL WHERE bulgingFontanelle = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET pharyngealErythema = NULL WHERE pharyngealErythema = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET pharyngealExudate = NULL WHERE pharyngealExudate = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET oedemaFaceNeck = NULL WHERE oedemaFaceNeck = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET oedemaLowerExtremity = NULL WHERE oedemaLowerExtremity = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET lossSkinTurgor = NULL WHERE lossSkinTurgor = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET palpableLiver = NULL WHERE palpableLiver = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET palpableSpleen = NULL WHERE palpableSpleen = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET malaise = NULL WHERE malaise = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET sunkenEyesFontanelle = NULL WHERE sunkenEyesFontanelle = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET sidePain = NULL WHERE sidePain = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET fluidInLungCavity = NULL WHERE fluidInLungCavity = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET tremor = NULL WHERE tremor = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET hydrophobia = NULL WHERE hydrophobia = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET opisthotonus = NULL WHERE opisthotonus = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET anxietyStates = NULL WHERE anxietyStates = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET delirium = NULL WHERE delirium = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET uproariousness = NULL WHERE uproariousness = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET paresthesiaAroundWound = NULL WHERE paresthesiaAroundWound = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET excessSalivation = NULL WHERE excessSalivation = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET insomnia = NULL WHERE insomnia = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET paralysis = NULL WHERE paralysis = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET excitation = NULL WHERE excitation = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET dysphagia = NULL WHERE dysphagia = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET aerophobia = NULL WHERE aerophobia = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET hyperactivity = NULL WHERE hyperactivity = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET paresis = NULL WHERE paresis = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET agitation = NULL WHERE agitation = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET ascendingFlaccidParalysis = NULL WHERE ascendingFlaccidParalysis = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET erraticBehaviour = NULL WHERE erraticBehaviour = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET coma = NULL WHERE coma = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET respiratoryDiseaseVentilation = NULL WHERE respiratoryDiseaseVentilation = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET generalSignsOfDisease = NULL WHERE generalSignsOfDisease = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET fastHeartRate = NULL WHERE fastHeartRate = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET oxygenSaturationLower94 = NULL WHERE oxygenSaturationLower94 = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET convulsion = NULL WHERE convulsion = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET otherHemorrhagicSymptoms = NULL WHERE otherHemorrhagicSymptoms = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET otherNonHemorrhagicSymptoms = NULL WHERE otherNonHemorrhagicSymptoms = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET alteredConsciousness = NULL WHERE alteredConsciousness = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET confusedDisoriented = NULL WHERE confusedDisoriented = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET hemorrhagicSyndrome = NULL WHERE hemorrhagicSyndrome = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET hyperglycemia = NULL WHERE hyperglycemia = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET hypoglycemia = NULL WHERE hypoglycemia = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET meningealSigns = NULL WHERE meningealSigns = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET seizures = NULL WHERE seizures = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET sepsis = NULL WHERE sepsis = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET shock = NULL WHERE shock = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET bilateralCataracts = NULL WHERE bilateralCataracts = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET unilateralCataracts = NULL WHERE unilateralCataracts = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET congenitalGlaucoma = NULL WHERE congenitalGlaucoma = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET pigmentaryRetinopathy = NULL WHERE pigmentaryRetinopathy = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET purpuricRash = NULL WHERE purpuricRash = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET microcephaly = NULL WHERE microcephaly = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET developmentalDelay = NULL WHERE developmentalDelay = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET splenomegaly = NULL WHERE splenomegaly = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET meningoencephalitis = NULL WHERE meningoencephalitis = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET radiolucentBoneDisease = NULL WHERE radiolucentBoneDisease = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET congenitalHeartDisease = NULL WHERE congenitalHeartDisease = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET fluidInLungCavityAuscultation = NULL WHERE fluidInLungCavityAuscultation = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET fluidInLungCavityXray = NULL WHERE fluidInLungCavityXray = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET abnormalLungXrayFindings = NULL WHERE abnormalLungXrayFindings = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET conjunctivalInjection = NULL WHERE conjunctivalInjection = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET acuteRespiratoryDistressSyndrome = NULL WHERE acuteRespiratoryDistressSyndrome = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET pneumoniaClinicalOrRadiologic = NULL WHERE pneumoniaClinicalOrRadiologic = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET lossOfTaste = NULL WHERE lossOfTaste = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET lossOfSmell = NULL WHERE lossOfSmell = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET wheezing = NULL WHERE wheezing = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET skinUlcers = NULL WHERE skinUlcers = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET inabilityToWalk = NULL WHERE inabilityToWalk = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET inDrawingOfChestWall = NULL WHERE inDrawingOfChestWall = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET otherComplications = NULL WHERE otherComplications = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET feverishFeeling = NULL WHERE feverishFeeling = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET weakness = NULL WHERE weakness = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET fatigue = NULL WHERE fatigue = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET coughWithoutSputum = NULL WHERE coughWithoutSputum = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET breathlessness = NULL WHERE breathlessness = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET chestPressure = NULL WHERE chestPressure = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET blueLips = NULL WHERE blueLips = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET bloodCirculationProblems = NULL WHERE bloodCirculationProblems = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET palpitations = NULL WHERE palpitations = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET dizzinessStandingUp = NULL WHERE dizzinessStandingUp = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET highOrLowBloodPressure = NULL WHERE highOrLowBloodPressure = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET urinaryRetention = NULL WHERE urinaryRetention = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET shivering = NULL WHERE shivering = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET generalBodilyPains = NULL WHERE generalBodilyPains = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET abdominalCramps = NULL WHERE abdominalCramps = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET difficultySwallow = NULL WHERE difficultySwallow = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET skinRashNew = NULL WHERE skinRashNew = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET redEyes = NULL WHERE redEyes = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET swollenLymphNodesBehindEars = NULL WHERE swollenLymphNodesBehindEars = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET muscleTone = NULL WHERE muscleTone = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET deepTendonReflex = NULL WHERE deepTendonReflex = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET muscleVolume = NULL WHERE muscleVolume = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET sensoryLoss = NULL WHERE sensoryLoss = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET nonVascular = NULL WHERE nonVascular = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET dyspnea = NULL WHERE dyspnea = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET tachypnea = NULL WHERE tachypnea = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET diarrhoea = NULL WHERE diarrhoea = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET headaches = NULL WHERE headaches = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET babyDied = NULL WHERE babyDied = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET babyNormalAtBirth = NULL WHERE babyNormalAtBirth = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET normalCryAndSuck = NULL WHERE normalCryAndSuck = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET stoppedSuckingAfterTwoDays = NULL WHERE stoppedSuckingAfterTwoDays = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET stiffness = NULL WHERE stiffness = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET emergenceOfGuineaWorm = NULL WHERE emergenceOfGuineaWorm = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET firstWormThisYear = NULL WHERE firstWormThisYear = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET caseDetectedBeforeWormEmergence = NULL WHERE caseDetectedBeforeWormEmergence = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET bodyAche = NULL WHERE bodyAche = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET dizziness = NULL WHERE dizziness = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET excessiveSweating = NULL WHERE excessiveSweating = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET numbness = NULL WHERE numbness = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET areLesionsSameState = NULL WHERE areLesionsSameState = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET areLesionsSameSize = NULL WHERE areLesionsSameSize = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET areLesionsDeep = NULL WHERE areLesionsDeep = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET areUlcersAmong = NULL WHERE areUlcersAmong = 'UNKNOWN'");
				getDao(Symptoms.class).executeRaw("UPDATE symptoms SET abnormalLungAuscultation = NULL WHERE abnormalLungAuscultation = 'UNKNOWN'");
				break;
