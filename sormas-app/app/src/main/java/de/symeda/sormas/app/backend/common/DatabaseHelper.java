...
import de.symeda.sormas.app.backend.sample.FieldSampleId;
import de.symeda.sormas.app.backend.sample.FieldSampleIdDao;
...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    public static void clearTables(boolean clearInfrastructure) {
        ...
        try {
            ...
            TableUtils.createTable(connectionSource, FieldSampleId.class);
    ...
    private void upgradeFromUnupgradableVersion(SQLiteDatabase db, ConnectionSource connectionSource, int oldVersion) {
        try {
            ...
            TableUtils.dropTable(connectionSource, FieldSampleId.class, true);
    ...
    public <ADO extends AbstractDomainObject> AbstractAdoDao<ADO> getAdoDaoInner(Class<ADO> type) {
        ...
        if (!adoDaos.containsKey(type)) {
            ...
            try {
                ...
                else if (type.equals(FieldSampleId.class)) {
                    dao = (AbstractAdoDao<ADO>) new FieldSampleIdDao((Dao<FieldSampleId, Long>) innerDao);
                }
                else {
    ...
    public static FieldSampleIdDao getFieldSampleIdtDao() {
        return (FieldSampleIdDao) getAdoDao(FieldSampleId.class);
    }
